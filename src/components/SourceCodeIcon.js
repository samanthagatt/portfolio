...
const SourceCodeIcon = ({ width = "auto", height = "auto", style = {} }) =>
    <svg role="img" viewBox="0 0 989 594" style={{ ...style, width: width, height: height }}>
        <title>Source code icon</title>
        <g transform="matrix(1.00045,0,0,1.00032,-44.6872,-234.032)">
